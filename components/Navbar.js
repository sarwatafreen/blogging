...
const Navbar = () => {
    ...
    return (
        <nav className="p-4 bg-background/50 sticky top-0 backdrop-blur border-b z-10 bg-gray-500">
            <LoadingBar
        color='#933ce6'
        progress={progress}
      ...
      />
            <div className="container mx-auto flex justify-between items-center">
                <Link href={"/"}><div className="text-2xl font-bold text-white">
                    Programmingos
                </div></Link>
                <div className="hidden md:flex space-x-4 items-center text-green-300">
